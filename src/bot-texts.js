...
const CHATS = {
  ...
  notifyDestHint:
    'Отметьте, куда слать сообщения из этого чата MAX: ЛС, пользователи и группы. Пользователя можно добавить по ссылке.',
  notifyDestNone:
  ...
  notifyDestWhereHint: 'Отметьте ЛС, пользователей и нужные группы, затем нажмите «Готово». Можно несколько получателей или только личка.',
};
