...
const CHATS = {
  ...
  bindGroupPrompt: [
    ...
    'После выбора бот проверит, есть ли у него права администратора.',
    '',
    'Если прав нет — пришлёт ссылку, чтобы добавить его в админы с нужными правами.',
  ].join('\n'),
  notAdmin: {
  ...
  notifyFooter: [
    ...
    'Если ❌ — нажмите «Добавить в админы»: откроется ссылка с нужными правами.',
    '',
