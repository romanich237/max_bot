...
const CHATS = {
  ...
  bound: {
    ...
    lines: (isGroup) => [
      isGroup
        ? 'Группа добавлена в список. В «Чаты MAX» отметьте, из каких чатов MAX слать сюда сообщения.'
  ...
  notifyDestNone:
    'Сейчас некуда слать — отметьте ЛС или группу ниже. Новые группы сначала добавьте в «Куда слать в Telegram».',
