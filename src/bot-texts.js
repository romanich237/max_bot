...
const CHATS = {
  ...
  infoFooter: [
    ...
    'Личные сообщения получают уведомления всегда, если для чата MAX включено ЛС. Группы из этого списка можно выбрать отдельно у каждого чата MAX.',
  ].join('\n'),
  notifyHeader: 'Куда приходят уведомления',
  notifyEmpty: 'Чаты для уведомлений пока не выбраны.',
  notifyDualMode: 'Режим: ниже — список групп, куда бот умеет писать. Куда слать каждый чат MAX, выбирается в «Чаты MAX».',
  notifyDmMode: 'Режим: уведомления только в личные сообщения, пока не добавите группу.',
  bindGroupPrompt: [
  ...
  notifyFooter: [
    'Это общий список чатов Telegram. Для каждого чата MAX в «Чаты MAX» можно включить ЛС и несколько групп.',
    '',
  ...
  bound: {
    ...
    lines: (isGroup) => [
      isGroup
        ...
        : 'Уведомления из MAX будут приходить в личные сообщения, если для чата включено ЛС.',
    ],
  },
  ...
  addPrompt: [
    ...
    'На кнопках — ссылки https://web.max.ru/… из этого списка. Личные чаты сразу уходят в ЛС; для групп можно выбрать ЛС и нужные группы Telegram.',
  ...
  addPromptNoScreenshot: [
    '<b>Добавить чат MAX</b>',
    '',
    'На кнопках — ссылки https://web.max.ru/… из списка слева. Личные чаты сразу уходят в ЛС; для групп можно выбрать ЛС и нужные группы Telegram.',
    'Если чатов много — листайте список кнопками ◀️ ▶️.',
    'Можно отправить название или ссылку вручную, например:',
    '<code>https://web.max.ru/-999999999999</code>',
    '',
  ...
  notifyTargetBoth: 'Куда слать: в личные сообщения и выбранные группы.',
  notifyDestHint:
    'Отметьте, куда слать сообщения из этого чата MAX: ЛС и нужные группы. Можно несколько групп или только личка.',
  notifyDestNone:
    'Сейчас некуда отправлять — отметьте ЛС или группу ниже. Новую группу добавьте кнопкой «Добавить группу Telegram».',
  notifyDestWhereTitle: 'Куда слать в Telegram',
  notifyDestWhereHint: 'Отметьте ЛС и нужные группы, затем нажмите «Готово». Можно несколько групп или только личка.',
};
